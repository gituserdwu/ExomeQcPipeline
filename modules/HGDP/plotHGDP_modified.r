mydata <- read.table("../test_HGDP_938.SeqPC.coord", header=TRUE, sep="\t");         ## Output coordinate file of LASER or TRACE for the study samples
Ref <- read.table("../test_HGDP_938.RefPC.coord", header=TRUE, sep="\t");   ## Reference coordinate file used in LASER or TRACE
...
png("../Results_on_HGDP_Mexican_breast_cancer_final.png")
